...
namespace ChanSort.Api
{
    ...
    public class DataRoot
  {
    ...
    public bool CanEditFavListName => this.loader.Features.CanEditFavListNames;
        ...
        /// Конструктор
        /// </summary>
        /// <param name="loader">Базовый сериализатор</param>
        public DataRoot(SerializerBase loader)
        {
            // Сохраняем базовый сериализатор с локальной переменной.  
            this.loader = loader;
        }

        #region AddSatellite()
        /// <summary>
        /// Добавить спутник в словарь спутниковю
        /// </summary>
        /// <param name="satellite">Данные о спутнике.</param>        
        public virtual void AddSatellite(Satellite satellite)
        {
            // Добавить спуитник в словарь спутников по идентификатору.
        ...
        /// <summary>
        /// Добавить спутник к транспондеру и сохранить транспондер в словаре по идентификатору.
        /// </summary>
        /// <param name="sat">Данные о спутнике</param>
        /// <param name="trans">Данные о транспонделе</param>
        public virtual void AddTransponder(Satellite sat, Transponder trans)
        {
            // Задать транспондеру спутник
            trans.Satellite = sat;
            // Проверить наличие такого транспондела с в ловаре по идентификатору
            ...
            // Добавить транспондер в словарь транспондеров спутника.
            sat?.Transponder.Add(trans.Id, trans);
            // Добавить транспондер в словарь транспондеров.
            this.Transponder.Add(trans.Id, trans);
        }
        #endregion AddTransponder()
        ...
        /// <summary>
        /// Добавить список каналов к списку скписков каналов.
        /// </summary>
        ...
        #endregion AddChannelList()

        #region AddChannel()
        /// <summary>
        /// Добавить данные о канале в список каналов.
        /// </summary>
        /// <param name="list">Целевой список каналов.</param>
        /// <param name="channel">Данные о канале</param>
        public virtual void AddChannel(ChannelList list, ChannelInfo channel)
        {
            // Проверяем список каналов на доступность.
            if (list == null)
            {
                this.Warnings.AppendFormat("No list found to add channel '{0}'\r\n", channel);
                return;
            }
            // Добавить канал к списку.
