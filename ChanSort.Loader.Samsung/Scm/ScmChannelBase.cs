...
namespace ChanSort.Loader.Samsung.Scm
{
  ...
  {
        /// <summary>
        /// Имена ключей из ini-файла.
        /// В ini-файле находятся значения для конкретной можели.
        /// </summary>
    // common
    ...
    /// <summary>
    /// Исходные не обработанные данные
    /// </summary>
